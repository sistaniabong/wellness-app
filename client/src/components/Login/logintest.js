...
const LoginTest = () => {
  ...
  return (
    <>
      <button className="m-6 waves-effect waves-light btn-floating" style={{borderRadius: '10px', width: '50px' }} onClick={showModal}>Login</button>
      <Modal 
        show={isOpen} 
        onHide={hideModal} 
      ...
      >
        ...
        <form onSubmit={handleLoginBtn}>
              ...
              </form><form onSubmit={handleLoginBtn}>
                <div className="input-group mb-3">
                  <span
                    className="input-group-text"
                    id="inputGroup-sizing-default"
        ...
        <button className="m-6 waves-effect waves-light btn-floating" style={{borderRadius: '10px', width: '65px' }} onClick={hideModal}>Cancel</button>
          <button className="m-6 waves-effect waves-light btn-floating" style={{borderRadius: '10px', width: '50px' }}>Save</button>
        </Modal.Footer>
      </Modal>
    </>
  );
